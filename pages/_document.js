  ...
  return (
    <Html lang="es">
      <Head>
        ...
        />
        <meta name="description" content="Contratos financieros binarios sobre economía y actualidad española. Opera con créditos virtuales en IBEX, Bitcoin, política y deportes." />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta name="theme-color" content="#FAFAFA" />
        <meta property="og:title" content="Forsii — Contratos financieros binarios" />
