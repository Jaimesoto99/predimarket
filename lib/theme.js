...
// Compact countdown: always Xd Xh Xmin, never truncated
...
// countdown: "8h 19min" or "¡Última hora!" or "Resolviendo..."
export function getCloseInfo(closeDate) {
  ...
  if (totalMin < 60) return { dateStr, countdown: '¡Última hora!', isUrgent: true, isExpired: false }
